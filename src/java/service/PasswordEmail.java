...
public class PasswordEmail extends AbstractFacade<Client> {
    ...
    public void recByEmailRegistre(Client client, String des, String emet) {
        ...
        try {
            ...
            message.setContent(emailHtmlService.sendHtmlEmailRegister(client.getNom()), "text/html");
            Transport.send(message);
            System.out.println("Done seftna lik nem");
